...
export default function PromoCard({ bloco, onClick }) {
  ...
  return (
    <div
      onClick={handleClick}
      className="group block h-full w-full cursor-pointer overflow-hidden rounded-[1.6rem] border border-[#e5e8e0] bg-white shadow-[0_16px_34px_rgba(15,23,42,0.05)] transition-all duration-300 hover:-translate-y-[2px] hover:shadow-[0_20px_44px_rgba(15,23,42,0.08)] dark:border-slate-700 dark:bg-slate-800"
    >
      <div className="aspect-[1.18/1] w-full shrink-0 border-b border-[#edf0ea] bg-[#f7f8f4] dark:border-slate-700 dark:bg-slate-700/60">
