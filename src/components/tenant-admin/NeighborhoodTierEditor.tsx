        ...
        <div className="space-y-4">
          {groups.map((group, groupIdx) => {
            ...
            return (
              <div
                key={group.id}
                className="rounded-2xl border border-slate-200 bg-white p-4.5 shadow-2xs space-y-3.5 transition-all hover:border-slate-300"
              >
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  <div className="flex items-center gap-2">
                    <span className="flex h-6 w-6 items-center justify-center bg-emerald-50 text-xs font-bold text-emerald-700 rounded-lg">
                      #{groupIdx + 1}
                    </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="h-8.5 w-full rounded-xl border border-slate-200 bg-slate-50/50 pl-8.5 pr-3 text-xs font-bold text-slate-900 outline-none focus:border-emerald-500 focus:bg-white"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="h-8.5 w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3 text-xs font-medium text-slate-900 outline-none focus:border-emerald-500 focus:bg-white"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <label className="text-[11px] font-semibold text-slate-700 flex items-center gap-1">
                      ...
                      Bairros inclusos nesta faixa ({group.bairros.length})
                    </label>
                    <span className="text-[10px] text-slate-400">
                      Dica: você pode colar vários bairros com vírgula
                    </span>
                  </div>

                  <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-2.5 min-h-[58px] flex flex-wrap gap-1.5 items-center transition-all focus-within:border-emerald-500 focus-within:bg-white">
                    ...
                    <div className="flex flex-1 min-w-[220px] items-center gap-1">
                      <input
                        ...
                        placeholder={
                          group.bairros.length === 0
                            ? 'Digite o nome do bairro e aperte Enter...'
                        ...
                        className="h-7.5 w-full bg-transparent px-1 text-xs font-medium text-slate-800 placeholder:text-slate-400 outline-none"
                      />
                      ...
                      {currentInput.trim().length > 0 && (
                        <button
                          ...
                          className="shrink-0 rounded-md bg-emerald-600 px-2 py-1 text-[10px] font-bold text-white shadow-2xs hover:bg-emerald-700 transition-colors cursor-pointer"
                        >
                          + Adicionar
                        </button>
                      )}
