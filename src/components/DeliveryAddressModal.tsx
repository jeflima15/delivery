...
type Props = { isOpen: boolean; onClose: () => void; onConfirmDelivery: (address: any) => void; user: any; tenantSlug?: string | null };
const empty = { cep: '', logradouro: '', numero: '', complemento: '', referencia: '', bairro: '', cidade: '', estado: '' };

export default function DeliveryAddressModal({ isOpen, onClose, onConfirmDelivery, user, tenantSlug }: Props) {
