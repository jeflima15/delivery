...
const envSchema = z.object({
  ...
  MONGODB_ATLAS_CLIENT_ID: z.string().trim().min(1).optional(),
  MONGODB_ATLAS_CLIENT_SECRET: z.string().trim().min(20).optional(),
  MONGODB_ATLAS_PROJECT_ID: z.string().trim().regex(/^[a-f\d]{24}$/i).optional(),
  MONGODB_ATLAS_CLUSTER_NAME: z.string().trim().min(1).optional(),
  SUPABASE_MANAGEMENT_TOKEN: z.string().trim().min(20).optional(),
